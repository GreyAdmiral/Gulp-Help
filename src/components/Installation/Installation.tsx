...
const instructions = [
   {
      text: 'Распакуйте архив со сборкой в любую удобную для Вас папку',
   },
   {
...
export const Installation = () => {
   return (
      <section className={styles.installation}>
         ...
         <p>
            <b>P.S.</b> Если всё сделано правильно, то, в режиме разработки, запустится локальный сервер и откроется
            браузер.
         </p>
      </section>
   );
