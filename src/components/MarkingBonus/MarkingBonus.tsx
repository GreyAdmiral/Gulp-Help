         ...
         <article className={styles.markingBonusBody}>
            ...
            <div className={classNames(styles.markingBonusItem, styles.markingBonusItemMenu)}>
               ...
               <p>
                  ...
                  <code>html/modules/settings/navigations/navigation/menu.html</code>. Все необходимые параметры
                  задаются в виде свойств сериализованного объекта. Массив таких объектов и составляет содержимое меню.
                  Пример содержимого такого файла можно увидеть на скриншоте рядом.
               </p>
            </div>
         </article>
